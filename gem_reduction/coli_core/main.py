...
def single_double_triple_deletions(cobra_model):
    ...
    for rxn in tqdm(range(len(cobra_model.reactions))):
        with cobra_model:
    ...
    print('Started double deletions')
    ...
    counter = 0
    for rxn_a in tqdm(range(len(cobra_model.reactions))):
...
#     print('Started triple deletions')
